...
Add `--benchmark-save=benchmark_results` option to save your test results in json file. It can be later used to compare
results between different runs. See [url](https://pytest-benchmark.readthedocs.io/en/latest/comparing.html) for more details.
