...
``empty-lines-between-sections`` rule should now work with empty sections with Robot Framework 6.1.

Fix for empty-metadata not reported in Robot Framework 6.1
-----------------------------------------------------------

``empty-metadata`` rule should now work with Robot Framework 6.1.
