...
Several rules stopped working after Robot Framework 6.1 release. There is list of fixes:

    - W1003 ``empty-lines-between-sections`` rule should now work with empty sections
    - W0511 ``empty-metadata`` rule should now work
    - E0403 ``missing-keyword-name`` rule should now work
