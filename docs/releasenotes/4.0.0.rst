...
New rule for double negation in conditions (#896)
-------------------------------------------------

Added new rule I0926 ``double-negation-in-condition`` that checks if the evaluated condition contains unnecessary
double negation.

An example of such issue::
