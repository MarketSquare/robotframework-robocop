...
import robocop
from docs_mk.rules_metadata import GROUPS_LOOKUP
...
If you want to learn more about the rules and their features, see [rules](#rules).
...
>
> This rule supports dynamic severity configurable using thresholds ([severity-threshold](#severity-threshold)).
...
| ------ | --------------- | ------ | ------------- |
{% for rule_param in rule_doc.params %}| {{ rule_param.name }} | {{ rule_param.default }} | {{ rule_param.type }} | {{ rule_param.desc }} |
{% endfor %}
