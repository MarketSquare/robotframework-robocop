...
Keyword That Should Be Split On Every Line
    ...
    ...            ${myVeryLongDefinitionOfAnElementmyVeryLongDefinitionOfAnElementmyVeryLongDefinitionOfAnElement}
    ...            ${addingTheSecondArgumentMakesThisLineTooLong}
    ...
    ...        AND
    ...        Element Should Contain
    ...            ${myVeryLongDefinitionOfAnElementmyVeryLongDefinitionOfAnElementmyVeryLongDefinitionOfAnElementmyVeryLongDefinitionOfAnElementmyVeryLongDefinitionOfAnElementmyVeryLongDefinitionOfAnElement}
    ...            ${addingTheSecondArgumentMakesThisLineTooLong}
