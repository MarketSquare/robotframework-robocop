...
class TestTimeTakenReport:
    ...
    def test_version_report(self, compare_runs, previous_results, empty_config, capsys):
        mock_time = mock.Mock()
        ...
        with mock.patch("robocop.linter.reports.time_taken_report.timer", mock_time):
            report = TimeTakenReport(empty_config)
    ...
    def test_persistent_save(self, compare_runs, get_report, expected_time, empty_config):
        mock_time = mock.Mock()
