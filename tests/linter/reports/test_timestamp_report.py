...
class TestTimestampReport:
    def test_timestamp_report(self, empty_config, capsys):
        report = TimestampReport(empty_config)
    ...
    def test_timestamp_report_configure(self, name, value, expected, empty_config, capsys):
        self._configure_and_run(name, value, empty_config)
        out, _ = capsys.readouterr()
    ...
    def test_timestamp_configure_invalid(self, name, value, expected, empty_config):
        report = TimestampReport(empty_config)
        with pytest.raises(ConfigurationError) as err:
            report.configure(name, value)
        assert expected in str(err)

    def test_invalid_timestamp_report(self, empty_config):
        report = TimestampReport(empty_config)
    ...
    def test_timestamp_default_warning(self, name, value, expected, empty_config, capsys):
