...
class TestDisablers:
    def test_disabled_whole_file(self):
        disabler = DisablersFinder(Path(Path(__file__).parent.parent, 'test_data', 'disabled', 'disabled_whole.robot'), None)
        assert disabler.file_disabled
        disabler = DisablersFinder(Path(Path(__file__).parent.parent, 'test_data', 'disabled', 'disabled.robot'), None)
    ...
    def test_enabled_file(self):
        disabler = DisablersFinder(Path(Path(__file__).parent.parent, 'test_data', 'disabled', 'enabled.robot'), None)
